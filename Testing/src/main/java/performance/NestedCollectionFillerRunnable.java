...
public class NestedCollectionFillerRunnable<K, V> implements Runnable {

	private Map<K, V> collection;
	private List<Entry<K, V>> values;
	private BiFunction<V, V, V> operation;

	public NestedCollectionFillerRunnable(Map<K, V> collection, List<Entry<K, V>> values, BiFunction<V, V, V> operation) {
